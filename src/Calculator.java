...
public class Calculator {
    ...
    private Deque<String> operations = new ArrayDeque<>();
    private Deque<BigInteger> numbers = new ArrayDeque<>();
    private Deque<String> postfix = new ArrayDeque<>();
    ...
    /**
     * function that defines operation leveling
     * @param c - operation character
     * @return - level of the operation
     */
    ...
    /**
     * Function makes String "input" more easy-working with
